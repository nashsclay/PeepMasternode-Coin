# PeepMasternode-Coin Setup

If you just want the commands for VPS setup:
```
wget https://raw.githubusercontent.com/nashsclay/PeepMasternode-Coin/master/peepmasternode_create.sh
chmod +x peepmasternode_create.sh  
./peepmasternode_create.sh 
```

This PeepMasternode-Coin (MN) script will automatically install almost all of the MN for you. You just need to have your masternode genkey ready. This code comes from Zoldurs many many forks for MN scripts, visit his page here. https://github.com/zoldur  
...
Download the newest wallet for your computer here: http://www.peepmasternode.com/
...
Next type in the amount of coins you wish to send to your MN (this coin should be 3000000 PMN. NO more NO less). Once done, click Send
...
## To Install the PeepMasternode-Coin on VPS Server
...
`peepmasternoded masternode status`
...
This will give you access to the folder of PeepMasternode-Coin files. Notice the period in front of the folder. If your are in the home folder and do **ls** command, it will not show the folder. Period means hidden. Correct command to display this folder in the home folder is **ls -al**

`cd ~/.PeepMasternode`


You can always DM me on discord at nashsclay#6809
